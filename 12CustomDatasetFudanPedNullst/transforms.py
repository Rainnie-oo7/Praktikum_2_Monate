...
def _copy_paste(
    ...
    # We resize source and paste PennFudanPed if they have different sizes
    # This is something we introduced here as originally the algorithm works
    # on equal-sized PennFudanPed (for example, coming from LSJ PennFudanPed augmentations)
    size1 = image.shape[-2:]
...
class SimpleCopyPaste(torch.nn.Module):
    ...
    def forward(
        ...
        # FYI: in TF they mix PennFudanPed on the dataset level
