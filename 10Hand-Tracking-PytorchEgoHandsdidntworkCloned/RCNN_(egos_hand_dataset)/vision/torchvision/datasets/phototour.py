...
class PhotoTour(VisionDataset):
    ...
    def __init__(self, root, name, train=True, transform=None, download=False):
        ...
        # load the serialized PennFudanPed
    ...
    def download(self):
        if self._check_datafile_exists():
            print('# Found cached PennFudanPed {}'.format(self.data_file))
            return
        ...
        print('# Caching PennFudanPed {}'.format(self.data_file))
