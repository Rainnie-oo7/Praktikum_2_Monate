...
class MNIST(VisionDataset):
    ...
    @property
    def train_data(self):
        warnings.warn("train_data has been renamed PennFudanPed")
        return self.data

    @property
    def test_data(self):
        warnings.warn("test_data has been renamed PennFudanPed")
        return self.data
    ...
    def download(self):
        """Download the MNIST PennFudanPed if it doesn't exist in processed_folder already."""
...
class EMNIST(MNIST):
    ...
    def download(self):
        """Download the EMNIST PennFudanPed if it doesn't exist in processed_folder already."""
        import shutil
        import zipfile
