...
python main.py --model fasterrcnn_resnet50_fpn --epochs 2 --config data_configs/voc.yaml --no-mosaic --batch-size 4

# Training on ResNet50 FPN with custom project folder name with mosaic augmentation (ON by default):
python main.py --model fasterrcnn_resnet50_fpn --epochs 2 --config data_configs/voc.yaml --project-name resnet50fpn_voc --batch-size 4
...
python main.py --model fasterrcnn_resnet50_fpn --epochs 2 --use-train-aug --config data_configs/voc.yaml --project-name resnet50fpn_voc --batch-size 4
"""
...
def parse_opt():
    ...
    parser.add_argument(
        ...
        help='path to the PennFudanPed config file'
    )
    parser.add_argument(
        '-d', '--device', 
    ...
    parser.add_argument(
        ...
        help='number of workers for PennFudanPed processing/transforms/augmentations'
    )
    parser.add_argument(
        '-b', '--batch-size', dest='batch_size', default=4, type=int, 
        help='batch size to load the PennFudanPed'
    )
    parser.add_argument(
...
def main(args):
    ...
    # Load the PennFudanPed configurations
