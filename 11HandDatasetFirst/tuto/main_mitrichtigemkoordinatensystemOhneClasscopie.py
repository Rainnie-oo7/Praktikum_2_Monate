...
img = Image.open('/home/boris.grillborzer/PycharmProjects/00CNNundRNN/boris.grillborzer/11HandDatasetFirst/PennFudanPed/CARDS_COURTYARD_B_T/frame_0036.jpg')
...
myleft = data['myleft'][0, 1]
myright = data['myright'][0, 1]
yourleft = data['yourleft'][0, 1]
yourright = data['yourright'][0, 1]
